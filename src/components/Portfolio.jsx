...
const categories = [
  {
    ...
    plans: [
      { title: 'Basic', description: 'Perfect for startups or personal brands.', price: 'R150 – R800', features: ['2–3 logo concepts', '2 revisions', 'Final files: PNG, JPG & PDF'] },
      { title: 'Standard', description: 'For growing brands who want versatility and refinement.', price: 'R1 000 – R1 500', features: ['3–4 concepts', 'Unlimited revisions', 'Vector + all file formats', 'Full, icon & watermark variations'] },
      { title: 'Premium + Mini Brand Kit', description: 'Your complete brand identity foundation.', price: 'R1 000 – R3 000', features: ['All Standard features', 'Color palette & typography', 'Social media profile & cover design'] },
      { title: 'Logo Refresh', description: 'A modern update while keeping brand recognition.', price: 'R200 – R800', features: ['Modernised version', 'Vector files', 'Optional typography update'] },
      { title: 'Icon Suite', description: 'Custom icons or monograms for apps, social media, or print.', price: 'R250 – R600', features: ['3–5 icons or monograms', 'Consistent color & style'] },
    ],
    slides: [
  ...
  },
  {
    ...
    plans: [
      { title: 'Business Basics', description: 'Essential branded documents for new businesses or professionals.', price: 'R200 – R400 / item', features: ['Email signature', 'Letterhead', 'Business cards'] },
      { title: 'Product & Packaging', description: 'Ideal for small product-based businesses and boutiques.', price: 'R500 – R2 500', features: ['Label / jar / box design', 'Sticker designs', 'Print-ready packaging layout'] },
      { title: 'Corporate & Publication', description: 'Professional long-format layouts for business use.', price: 'R800 – R3 000', features: ['Magazine ads A4/DPS', 'Business branding signs'] },
      { title: 'Event & Personal Print', description: 'For weddings, birthdays, and special occasions.', price: 'R250 – R1 500', features: ['Invitation set', 'Save-the-date card', 'Thank-you card', 'Menu design'] },
    ],
    slides: [
  ...
  },
  {
    ...
    plans: [
      { title: 'Website Graphic Set', description: 'For businesses needing simple, clean visuals for their site.', price: 'R650 – R1 200', features: ['Hero banner', 'CTA button graphic', 'Footer / sidebar visual', 'Profile + cover banner', 'Instagram stories & highlights'] },
      { title: 'Full Website Graphics Pack', description: 'For a full site launch or complete visual refresh.', price: 'R1 500 – R3 500', features: ['Desktop + mobile hero banner', '3 section graphics', '3 custom icons or badges', 'All files for web + mobile'] },
      { title: 'Social + Web Launch Combo', description: 'Matching visuals across website + social platforms.', price: 'R1 500 – R3 000', features: ['Website hero banner', '3 web section graphics', '3 branded Instagram posts', '5-icon story highlight set'] },
      { title: 'Website Build + Hosting', description: 'A fully integrated website with development, hosting, and custom branding.', price: 'R3 000 – R6 000', features: ['Fully built website (1–6 pages)', 'Custom graphics & banners', 'Mobile + tablet responsive', 'Hosting & domain setup', 'Light / dark mode'] },
      { title: 'Digital Ad Campaign Kit', description: 'Branding that carries across email + web presence.', price: 'R1 000 – R2 000', features: ['5 ad sizes (square, landscape, vertical)', 'Facebook & Instagram ads', 'Email header banner', 'Favicon + branded button set'] },
    ],
    slides: [
