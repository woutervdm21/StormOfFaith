...
export default function Footer() {
  return (
    <footer className="bg-ink dark:bg-black">
      <div className="max-w-5xl mx-auto px-6 py-14 grid grid-cols-1 md:grid-cols-3 gap-10">
        ...
        <div className="space-y-3">
          ...
          <p className="text-xs italic text-white/25 pt-1">
        ...
        {/* Navigation */}
        <div>
          <p className="text-[10px] tracking-[0.2em] uppercase text-white/25 mb-4">Navigate</p>
        ...
        {/* Contact + socials */}
        <div>
          <p className="text-[10px] tracking-[0.2em] uppercase text-white/25 mb-4">Get In Touch</p>
          <div className="space-y-2.5 mb-5">
            <a href="mailto:stormyvisions@yahoo.com" className="block text-sm text-white/50 hover:text-white transition-colors duration-200">
              stormyvisions@yahoo.com
            </a>
            <a href="tel:+27796499728" className="block text-sm text-white/50 hover:text-white transition-colors duration-200">
              +27 79 649 9728
            </a>
            <p className="text-sm text-white/30">Middelburg, South Africa</p>
          </div>
      ...
      {/* Bottom bar */}
      <div className="border-t border-white/[0.06] py-5 text-center px-6">
